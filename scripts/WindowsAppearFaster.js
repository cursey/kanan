...
var pattern1 = scan('74 ?? E8 ?? ?? ?? ?? 85 C0 74 ?? F6 46 14 ?? 75 ?? 8B 10 8B C8 8B 82 74 01 00 00 FF D0 84 C0 75 ?? 83 BE A8 00 00 00 ?? C6 86 A4 00 00 00 ?? 75 ?? B9 ?? ?? ?? ?? E8 ?? ?? ?? ?? 89 86 A8 00 00 00 8B 4D 08');
